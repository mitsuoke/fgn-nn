...
| `script.js` | Навигация, анимации, Метрика, согласие на аналитику, цели, форма, текущий год |
...
| Фасовка чая и сборов | `/fgn-nn/fasovka-chaya-i-sborov/` | Получить запрос на фасовку чая и травяных сборов |
| Упаковка и маркировка БАД | `/fgn-nn/upakovka-i-markirovka-bad/` | Получить запрос на упаковку и маркировку готовой продукции |
