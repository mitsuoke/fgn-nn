...
5. передаёт введённые данные через встроенную CRM-форму Bitrix24.
...
Если в будущем встроенная CRM-форма будет заменена собственной API-интеграцией, необходимо:
